...
while cap.isOpened():
    ...
    if ret is not None:
        ...
        results = culinaryDetector.predict(frame,imgsz=(1088,736), device=0, conf=0.75, verbose=False)
        ...
        cv2.imshow('Culinary detect app',cv2.resize(img,(FRAME_WIDTH,FRAME_HEIGHT)))
